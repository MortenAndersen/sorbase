...
function simpletheme_widgets_init() {
	...
	register_sidebar(
		array(
			...
			'before_widget' => '<div id="%1$s" class="widget widget--small--txt infobar-widget %2$s">',
			'after_widget'  => '</div>',
	...
	register_sidebar(
		array(
			...
			'before_widget' => '<div id="%1$s" class="widget top-container-widget %2$s">',
			'after_widget'  => '</div>',
			'before_title'  => '<h5 class="widget-title">',
			'after_title'   => '</h5>',
		)
	...
	register_sidebar(
		array(
			...
			'before_widget' => '<div id="%1$s" class="widget pre-footer-widget %2$s">',
			'after_widget'  => '</div>',
			'before_title'  => '<h5 class="widget-title">',
			'after_title'   => '</h5>',
		)
	...
	register_sidebar(
		array(
			...
			'before_widget' => '<div id="%1$s" class="widget important-widget widget--small--txt %2$s">',
			'after_widget'  => '</div>',
	...
	register_sidebar(
		array(
			...
			'before_widget' => '<div id="%1$s" class="widget frontpage-grid-widget flex-item %2$s">',
			'after_widget'  => '</div>',
	...
	register_sidebar(
		array(
			...
			'before_widget' => '<div id="%1$s" class="widget mobilemenu-widget %2$s">',
			'after_widget'  => '</div>',
			'before_title'  => '<h5 class="widget-title">',
			'after_title'   => '</h5>',
		)
	...
	array(
			...
			'before_widget' => '<div id="%1$s" class="widget mobilemenu-widge %2$s">',
			'after_widget'  => '</div>',
			'before_title'  => '<h5 class="widget-title">',
			'after_title'   => '</h5>',
		)
	...
	register_sidebar(
		array(
			...
			'before_widget' => '<div id="%1$s" class="widget top-container-widget banner %2$s">',
			'after_widget'  => '</div>',
